import {Animated, Platform, ScrollView, Text, TextInput, TouchableOpacity, View, Image, StyleSheet} from 'react-native'
            ...
            <View>
                ...
                <View>
                    ...
                    <View className={`flex flex-row justify-between`}>
                        <View className={`flex`}>
                            <StyledTouchableOpacity className={'w-full rounded-md bg-slate-600 py-3 px-4 mt-2'}
                                                    onPress={() => uploadImage()}>
                        ...
                        <View className={`flex w-full pl-4`}>
                            {image &&
                                <Image source={{uri: image}}
                                       style={{width: 300, borderRadius: 8, aspectRatio: 4 / 3, resizeMode: 'cover'}}
                                />
                            }
                        </View>
                    </View>
